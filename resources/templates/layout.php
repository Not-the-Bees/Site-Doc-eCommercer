            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="/Talk-About-Stuff/controllers/profile.php"><i class="fa fa-home"></i> HOME</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/Talk-About-Stuff/controllers/profile.php"><i class="fa fa-user-circle"></i>  <?= ucfirst($_SESSION['login']) ?>'s PROFILE</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/Talk-About-Stuff/controllers/logout.php"><i class="fa fa-sign-out"></i> LOGOUT</a>
                        </li>
                    </ul>
